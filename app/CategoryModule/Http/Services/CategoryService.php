...
namespace App\CategoryModule\Http\Services;
...
class CategoryService implements CategoryServiceInterface
{
    ...
    {
        return $this->category->query()->published()->get();
    }
    ...
    {
        return $this->category->query()->findOrFail($categoryId);
    }
     ...
     * @return Collection
     */
    public function getCategoriesListById(array $categoryIds): Collection
    {
        return $this->category->query()->findMany($categoryIds);
    }
    ...
    public function getDefaultCategories(): array
    {
        return [
            [
                'slug' => Str::snake('Women\'s', '-'),
                'title' => 'Women\'s',
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-heart mb-2" viewBox="0 0 16 16">
            ...
            [
                'slug' => Str::snake('Juice', '-'),
                'title' => 'Juice',
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-cup mb-2" viewBox="0 0 16 16">
            ...
            [
                'slug' => Str::snake('Foods', '-'),
                'title' => 'Foods',
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-egg-fried mb-2" viewBox="0 0 16 16">
            ...
            [
                'slug' => Str::snake('Sports', '-'),
                'title' => 'Sports',
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-controller mb-2" viewBox="0 0 16 16">
            ...
            [
                'slug' => Str::snake('Gadget', '-'),
                'title' => 'Gadget',
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-earbuds mb-2" viewBox="0 0 16 16">
            ...
            [
                'slug' => Str::snake('Travel', '-'),
                'title' => 'Travel',
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-brightness-high mb-2" viewBox="0 0 16 16">
