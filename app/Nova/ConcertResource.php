...
class ConcertResource extends Resource
{
     ...
     * @var string
     */
    public static $model = Concert::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Number::make(__('Ticket_price'), 'ticket_price'),
            Text::make(__('Venue'), 'venue'),
            Text::make(__('Address'), 'address')->hideFromIndex(),
            Text::make(__('City'), 'city')->hideFromIndex(),
            Text::make(__('State'), 'state')->hideFromIndex(),
            Number::make(__('Zip'), 'zip')->hideFromIndex(),
            Textarea::make(__('Additional Information'), 'additional_information')->hideFromIndex(),
        ];
    }
