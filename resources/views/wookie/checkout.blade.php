        ...
        <div class="container">
            ...
            <div class="checkout-wrapper-area py-3">
                ...
                <div class="billing-information-card mb-3">
                    <div class="card billing-information-title-card bg-danger">
                        <div class="card-body">
                            <h6 class="text-center mb-0 text-white">Shipping Information</h6>
                        </div>
                    </div>
                    <div class="card user-data-card">
                        <div class="card-body">
                ...
                <div class="card cart-amount-area">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <h5 class="total-price mb-0">$<span class="counter">{{Cart::total()}}</span></h5><a class="btn btn-warning" href="checkout-payment.html">Confirm &amp; Pay</a>
                    </div>
                </div>
            </div>
        </div>
