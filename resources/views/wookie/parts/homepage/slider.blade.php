                            ...
                            @foreach($slider->slides as $slide)
                                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000"
                                    ...
                                    <img
                                        ...
                                        data-lazyload="{{url($slide->image)}}" alt="slide1"
                                    ...
                                    <div class="tp-caption tp-caption1 lft stb"
                                        ...
                                        <div class="tp-caption1-wd-1 tt-base-color">{{$slide->title}}</div>
                                        {{--                                            <div class="tp-caption1-wd-2">Premium<br>Html Template</div>--}}
                                        <div class="tp-caption1-wd-3">{{$slide->subtitle}}</div>
                                        <div class="tp-caption1-wd-4"><a href="listing-left-column.html"
                                                                         target="_blank" class="btn btn-xl"
                                                                         data-text="SHOP NOW!">{{$slide->btn_text}}</a></div>
                                    </div>
                                </li>
                            @endforeach
{{--                            <li data-transition="fade" data-slotamount="1" data-masterspeed="1000"--}}
...
{{--                                <img--}}
{{--                                    src="data:image/png;base64,"--}}
{{--                                    data-lazyload="images/slides/01/slide-02.jpg" alt="slide1"--}}
{{--                                    data-bgposition="center center" data-bgfit="cover"--}}
{{--                                    data-bgrepeat="no-repeat">--}}
{{--                                <div class="tp-caption tp-caption1 lft stb"--}}
{{--                                     data-x="center"--}}
...
{{--                                    <div class="tp-caption1-wd-3 tt-white-color">Optimized for speed, website--}}
{{--                                        that sells--}}
{{--                                    </div>--}}
{{--                                    <div class="tp-caption1-wd-4"><a href="listing-left-column.html"--}}
{{--                                                                     target="_blank" class="btn btn-xl"--}}
...
{{--                                <img--}}
{{--                                    src="data:image/png;base64,"--}}
{{--                                    data-lazyload="video/blank.png" alt="slide1" data-bgposition="center center"--}}
...
{{--                                    <div class="tp-caption1-wd-2 tt-white-color">Find Products for<br>Shop Store--}}
{{--                                    </div>--}}
